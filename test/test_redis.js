...
// exports.arrayize = function(done) {
//   var u = new Puzzle({id: 1})
//   u.arrayize().should.eql(["id", "1"])
//   done()
// } 
...
exports.find_saved_non_existing_puzzle = function(done) {
  Puzzle.find(1234, function(u) {
    is.equal(u, null)  
    done()
  })
}
